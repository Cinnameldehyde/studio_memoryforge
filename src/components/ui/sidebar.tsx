...
const SIDEBAR_WIDTH = "14rem" // Decreased from 16rem
const SIDEBAR_WIDTH_MOBILE = "18rem"
const SIDEBAR_WIDTH_ICON = "2.75rem" // Decreased from 3rem
