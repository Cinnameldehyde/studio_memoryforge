...
const SIDEBAR_WIDTH = "10.5rem"; // Kept from previous user adjustment
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <SheetHeader className="sr-only"> {/* Added for accessibility */}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-hidden", // Changed from overflow-auto
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0", // Removed as icon-collapsed state is not used
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // "group-data-[collapsible=icon]:hidden", // Removed
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button mx-2 flex w-[calc(100%-1rem)] items-center gap-2 overflow-hidden rounded-full p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground",
  {
    variants: {
      variant: {
...
>(
  (
    ...
    const Comp = asChild ? Slot : "button"
    // const { isMobile, state } = useSidebar() // Removed useSidebar call
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          side="right"
          align="center"
          // hidden={state !== "collapsed" || isMobile} // Removed hidden logic
          {...tooltip}
        />
      </Tooltip>
    )
