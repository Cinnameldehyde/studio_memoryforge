    ...
    <section id={id} className="relative py-12 md:py-16 min-h-[60vh] flex items-center justify-center text-center overflow-hidden bg-transparent">
      ...
      <div className="container mx-auto px-4 z-10">
        <motion.h1 
          ...
          className="text-5xl md:text-7xl font-bold mb-6 pb-2 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-primary via-accent to-primary animate-gradient-x text-shadow-md"
        >
